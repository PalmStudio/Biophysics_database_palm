...
let
    ...
    ax = LScene(fig[1, 1])
    scatter!(ax, lidar.points, color=lidar.reflectance, markersize=5, alpha=0.5)
    ax2 = LScene(fig[1, 2])
    scatter!(ax2, lidar.points, color=lidar.reflectance, markersize=5, alpha=0.5)
...
git-tree-sha1 = "4f2b875ca432bf9263ca46af276a45df0905751a"
...
[[deps.PlantGeom]]
deps = ["ColorSchemes", "Colors", "EzXML", "LinearAlgebra", "Meshes", "MultiScaleTreeGraph", "Observables", "RecipesBase", "Rotations", "StaticArrays", "Tables", "TransformsBase", "UUIDs", "Unitful"]
git-tree-sha1 = "1ccafd3dd08b5f9caa84a650dc164c87ef7e8c5c"
uuid = "5edaa67e-25db-4eb9-bf81-05d793b2238d"
version = "0.7.0"
weakdeps = ["Makie"]

    [deps.PlantGeom.extensions]
