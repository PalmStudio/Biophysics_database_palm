...
- Leaf temperature, measured with a thermal camera. The code to control the camera is available [here](https://github.com/PalmStudio/FLIR_Vue_Pro-Raspberri_Pi)
