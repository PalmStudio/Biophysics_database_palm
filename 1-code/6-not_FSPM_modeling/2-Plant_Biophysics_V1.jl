...
# Simulate data
(!uncert) && (df[!, :Tleaf_sim] .= df[!,:E_sim] .= df[!, :λE_sim] .= df[!,:Rn_sim] .= df[!, :H_sim] .= df[!, :A_sim] .= df[!, :GH2O_sim] .= df[!, :ci_sim] .= df[!, :VPD_sim] .= df[!, :CO2_flux_sim] .= 0.)
(uncert) && (df[!, :Tleaf_sim] .= df[!,:E_sim] .= df[!, :λE_sim] .= df[!,:Rn_sim] .= df[!, :H_sim] .= df[!, :A_sim] .= df[!, :GH2O_sim] .= df[!, :ci_sim] .= df[!, :VPD_sim] .= df[!, :CO2_flux_sim] .= 0. ± 0.)
...
CSV.write("0-data/8-not_FSPM_modeling/CO2_flux_PlantBiophysics_output_5min.csv",df[!,[:DateTime_start,:CO2_flux_sim, :cum_area, :A_sim, :E_sim]])
