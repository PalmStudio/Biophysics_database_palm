...
# Load the data
climate = CSV.read("2-climate/climate_mic3_5min.csv", DataFrame)
leaf_temperature = open(Bzip2DecompressorStream, "5-thermal_camera_measurements/leaf_temperature.csv.bz2") do io
    CSV.read(io, DataFrame)
end
transpiration = open(Bzip2DecompressorStream, "6-transpiration/transpiration.csv.bz2") do io
    CSV.read(io, DataFrame)
end
CO2 = CSV.read("4-CO2/CO2_fluxes.csv", DataFrame)
